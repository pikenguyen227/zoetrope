...
Compiled, file-cited project knowledge lives in the vault; start at `_vaults/zoetrope/wiki/index.md`.
...
cargo fmt                       # format
cargo test                      # test
python3 -m unittest discover -s scripts -p 'test_*.py'   # fleet adapter; ZOE_REGENERATE_CREW=1 rewrites the adapter-generated assets/fleet/{crew,feed,validation,captains} fixtures
